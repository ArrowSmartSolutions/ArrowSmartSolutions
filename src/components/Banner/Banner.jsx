...
const Banner = () => {
  return (
    <section>
        <div className='container py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 space-y-6 md:space-y-0'>
            {/*Banner Image*/}
            ...
            <div className='flex flex-col justify-center gap-1'>
                <div className='text-center md:text-left space-y-8 sm:space-y-10 md:space-y-12'>
                    <motion.h1
