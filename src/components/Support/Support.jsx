  ...
  return (
    <section className='bg-light'>
      <div className='container py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24'>
        <h2 className='text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-center pb-8 sm:pb-10 md:pb-12 lg:pb-14 leading-tight'>Ongoing Support & Maintenance Plans</h2>
        ...
        <div className='text-center py-8 sm:py-10 md:py-12 lg:py-16'>
          <h3 className='text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold mb-3 sm:mb-4 md:mb-5 leading-tight'>Need a Bespoke Solution?</h3>
          <p className='text-xs sm:text-sm md:text-base lg:text-base text-dark2 max-w-[800px] mx-auto mb-5 sm:mb-6 md:mb-8 leading-relaxed'>For complex projects or unique business requirements, we're ready to craft a tailor-made proposal just for you. Reach out today for a personalized consultation.</p>
          <motion.button 
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
